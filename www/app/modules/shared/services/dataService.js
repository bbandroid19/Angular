...
//                var startDate = new Date(mainArr[i].SMStartDateOWSDATE).setHours(0, 0, 0, 0).valueOf();
//                //console.log(startDate);
//                var endDate = new Date(mainArr[i].SMEnddateOWSDATE).setHours(0, 0, 0, 0).valueOf();
//                //console.log(endDate);
//                //console.log(date);
//                if (date >= startDate && date <= endDate) {
//                    mainArr[i].ArrayStatus = "current";
//                    ////console.log("current");
//                } else if (startDate > date) {
//                    ////console.log("Future");
//                    mainArr[i].ArrayStatus = "future";
//                } else if (startDate < date && endDate < date) {
//                    mainArr[i].ArrayStatus = "past";
//                    ////console.log("Past");
//                }
...
////              $rootScope.ngProgressText="Fetching Meeting "+mainArr[arrCount].SMNameOWSTEXT +" Data..";
//            
...
//                            "SMStartTime": result[j].SMStartTime,
//                            "SMEndTime": result[j].SMEndTime,
...
//                            "SMAStartDate": result[j].SMAStartDate.split("T")[0].split("-")[1] + '-' + result[j].SMAStartDate.split("T")[0].split("-")[2] + '-' + result[j].SMAStartDate.split("T")[0].split("-")[0],
//                            "SMADiscussionPoints": "",
//                            "AttachArray": []
//                        };
//                        for (var y = 0; y < mainArr[arrCount].Days.length; y++) {
//                            console.log(arrCount);
//                            console.log(mainArr[arrCount].Days);
...
//
//            });
//            //            $q.all(agendaPromise).then(agendadeferred.resolve(mainArr));
//
...
//                var date_arr = [];
//                var dates = mainArr[i].SMSelDatesOWSMTXT.split('|')
//                    ////console.log(dates);
//                for (var l = 0; l < dates.length; l++) {
//                    if(dates[l].split(';')[2]){
//                    date_arr.push({
//                        "date": dates[l].split(";")[2],
